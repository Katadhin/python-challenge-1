...
print("John's Food Truck Ordering System - Copyright 2023. Press any key to get started.") # Launch the store and present a greeting to the customer
print("-" * 81) # Print a line to separate the greeting from the rest of the program

print() # Print a blank line
input() # Wait for the customer to press a key

# Welcome the customer to the store by name
...
place_order = True # This will be used to keep the order loop going
while place_order: # This will be used to keep the order loop going
    ...
    for key in menu.keys(): # Print the options to choose from menu headings (all the first level dictionary items in menu).
    ...
    menu_category = input("Type menu number: ") # Get the customer's input
    ...
    order_list = get_order_list(order_list) # Call the function with the order_list
    ...
    print(f"Sub-total: ${total:.2f}") # Print the total cost of the order with 2 decimal places
    print() # Print a blank line
...
total = sum([item["Price"] * item["Quantity"] for item in order_list]) # Calculate the cost of the order using list comprehension
print(f"Total: ${total:.2f}") # Print the total cost of the order with 2 decimal places
...
if text_alert.lower() == "y": # Check the customer's input
    ...
    print() # Print a blank line
    phone_number = input("What is your nine digit phone number? Use formt 'XXX-XXX-XXXX' ") # Ask the customer for their phone number
    print() # Print a blank line

#confirm the customer's phone number
print(f"Is {phone_number} correct?") # Confirm the customer's phone number
phone_number_correct = input("(Y)es or (N)o ") # Confirm the customer's phone number
if phone_number_correct.lower() == "y": # Check the customer's input
    # Thank the customer for confirming their phone number
    print("Thank you for confirming your phone number!") # Thank the customer for confirming their phone number
elif phone_number_correct.lower() == "n": # Check the customer's input
    # Ask the customer to try again
    print("Please try again.") # Ask the customer to try again
else:
    # Ask the customer to try again
    print("Please try again.")
print() # Print a blank line
...
text_alert = input("Would you like to opt in to receive text alerts for promotions and discounts? (Y)es or (N)o ") # Ask the customer if they would like to opt in to receive text alerts for promotions and discounts
print() # Print a blank line
if text_alert.lower() == "y": # Check the customer's input

    # Thank the customer for opting in to receive text alerts
    print("Thank you for opting in to receive text alerts for promotions and discounts!") # Thank the customer for opting in to receive text alerts
...
# Exit the program
print() # Print a blank line
print("Thank you for dining with John's Food Truck! Happy eating!") # Exit the program
